# 📦 AGENTO GitHub Structure - File Index
...
### 1. Download
Files are already in `/mnt/user-data/outputs/AGENTO-github/`
...
### 3. Quick Setup
```bash
# Copy to your AGENTO directory
cp -r AGENTO-github/* /path/to/your/AGENTO/
...
1. **Username/Email**
   ...
   - Search for `AGENTO.io` and update
