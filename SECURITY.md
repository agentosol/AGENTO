...
AGENTO handles real financial transactions and sensitive wallet information. Security is our highest priority. This document outlines our security practices and how to report vulnerabilities.
...
**Instead, email:** security@AGENTO.io
...
const socket = io('wss://api.AGENTO.io', {
  secure: true,
  rejectUnauthorized: true
});

// ❌ DON'T: Use unencrypted connections
const socket = io('ws://api.AGENTO.io'); // INSECURE
```
...
- **Email**: security@AGENTO.io
- **PGP Key**: [Download](https://AGENTO.io/security.asc)
...
We thank the security researchers who have helped make AGENTO more secure:
...
**Security is a shared responsibility.** Thank you for helping keep AGENTO and our users safe! 🛡️
