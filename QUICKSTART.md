# ⚡ AGENTO Quick Start Guide

Get AGENTO up and running in 5 minutes!
...
```bash
git clone https://github.com/AGENTO/AGENTO.git
cd AGENTO
```
...
4. Execute trade (careful!):
   "Buy 0.01 SOL of token [TOKEN_ADDRESS]"
```
...
### Community
- **Discord**: [Join here](https://discord.gg/AGENTO)
- **Twitter**: [@AGENTOAI](https://twitter.com/AGENTOai)
- **GitHub Discussions**: [Ask questions](https://github.com/AGENTO/AGENTO/discussions)

### Support
- **Documentation**: [docs.AGENTO.io](https://docs.AGENTO.io)
- **Email**: support@AGENTO.io
- **Issues**: [GitHub Issues](https://github.com/AGENTO/AGENTO/issues)

## 🎉 Success!

You're now ready to start trading with AGENTO! 
...
**Need help?** Join our [Discord](https://discord.gg/AGENTO) or open an [issue](https://github.com/AGENTO/AGENTO/issues).
